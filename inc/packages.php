<section class="page-section bg-dark" id="home">
	...
	<div class="d-flex w-100 justify-content-center">
		<hr class="border-warning" style="border:6px solid" width="15%">
	</div>
	<div class="d-flex w-100">
		...
		?>
            <div class="card w-100 rounded-0">
                <img class="card-img-top" src="<?php echo validate_image($cover) ?>" alt="<?php echo $row['title'] ?>" height="400rem" style="object-fit:cover">
                <div class="card-body">
